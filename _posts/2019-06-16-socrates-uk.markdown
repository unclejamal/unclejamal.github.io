...
- soon after [Dmitry](https://twitter.com/dmitrykandalov) and myself decided to run a mob programming session focusing on [test and commit or revert](https://medium.com/@kentbeck_7670/test-commit-revert-870bbd756864) using [Tennis kata](http://codingdojo.org/kata/Tennis)
